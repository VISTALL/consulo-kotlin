...
base <!WRONG_ANNOTATION_TARGET!>meta<!> type <!WRONG_ANNOTATION_TARGET!>method<!> <!WRONG_ANNOTATION_TARGET!>multiple<!> class KClass(@base @field <!WRONG_ANNOTATION_TARGET!>@parameter<!> val y: <!WRONG_ANNOTATION_TARGET!>@base<!> <!WRONG_ANNOTATION_TARGET!>@type<!> Int) {
    ...
    base method multiple <!WRONG_ANNOTATION_TARGET!>konstructor<!> fun foo(@parameter <!WRONG_ANNOTATION_TARGET!>@type<!> i: <!WRONG_ANNOTATION_TARGET!>@base<!> <!WRONG_ANNOTATION_TARGET!>@multiple<!> Int): <!WRONG_ANNOTATION_TARGET!>@field<!> <!WRONG_ANNOTATION_TARGET!>@parameter<!> Int {
